...
import 'package:safeboxx/auth/otp_page.dart';
...
abstract class LoginStoreBase with Store {
  ...
  Future<void> signOut(BuildContext context) async {
    await _auth.signOut();
    await Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => PhoneVerify()), (Route<dynamic> route) => false);
    firebaseUser = null;
  }
}